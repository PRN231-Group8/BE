    ...
    public class PostsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreatePost([FromForm] CreatePostRequest createPostRequest)
        {
            try
            {
                ...
                // Check for isRecommended field
                if (createPostRequest.IsRecommended == null)
                {
                    return BadRequest(new BaseResponse<object>
                    {
                        IsSucceed = false,
                        Message = "The isRecommended field is required and cannot be null."
                    });
                }
                ...
                return CreatedAtAction(nameof(CreatePost), new BaseResponse<PostsResponse>
                {
                    IsSucceed = true,
                    Result = result,
