        ...
        public MappingProfile()
        {
            ...
            CreateMap<Location, LocationResponse>()
                .ForMember(dest => dest.Photos,
                    opt => opt.MapFrom(src => src.Photos != null ? src.Photos.ToList() : null));
            CreateMap<Photo, PhotoResponse>();
            ...
            CreateMap<Tour, TourResponse>()
                ...
                .ForMember(dest => dest.LocationInTours,
                    opt => opt.MapFrom(src => src.LocationInTours.Select(lit => lit.Location)))
